...
public class TgOptions : OAuthOptions
{
    ...
    public TgOptions()
    {
        // Note this is the path that will be reserved for finishing the oauth handshake
        ...
        // For available scopes see: https://forums.tgstation13.org/viewtopic.php?f=45&t=30155
